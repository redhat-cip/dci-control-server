...
gcontext = dci_context.build_dci_context(
    ...
    dci_login='admin', dci_password='ovKbP9IRLaRfrz')
    #dci_cs_url='http://0.0.0.0:5000',
    #dci_login='admin',
    #dci_password='admin')
...
ljobs = job.list(gcontext, sort='-created_at', embed='components,jobdefinition').json()['jobs']
