...
def init_db(db_conn):
    ...
    db_ins(
        models.JOBS, status='killed', jobdefinition_id=jobdef_hp_1,
        remoteci_id=remoteci_hp_1, team_id=team_hp, created_at=time[3][12],
        updated_at=time[2][20]
    )
    db_ins(
    ...
    db_ins(
        models.JOBS, status='killed', jobdefinition_id=jobdef_dell_1,
        remoteci_id=remoteci_dell_1, team_id=team_dell, created_at=time[3][12],
        updated_at=time[2][20]
    )
    db_ins(
