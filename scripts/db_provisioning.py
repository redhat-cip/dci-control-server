...
def init_db(db_conn, minimal):
    ...
    job_id = db_ins(
        ...
        updated_at=time[0][1], user_agent='db_provisioning.py'
    )
    db_ins(
    ...
    job_id = db_ins(
        ...
        updated_at=time[0][2], user_agent='db_provisioning.py'
    )
    db_ins(
        models.JOIN_JOBS_COMPONENTS, job_id=job_id,
        component_id=component_common_1
    ...
    job_id = db_ins(
        ...
        updated_at=time[0][3], user_agent='db_provisioning.py'
    )
    db_ins(
        models.JOIN_JOBS_COMPONENTS, job_id=job_id,
        component_id=component_common_2
    ...
    job_id = db_ins(
        ...
        updated_at=time[0][7], user_agent='db_provisioning.py'
    )
    db_ins(
        models.JOIN_JOBS_COMPONENTS, job_id=job_id,
        component_id=component_common_2
    ...
    job_id = db_ins(
        ...
        updated_at=time[0][10], user_agent='db_provisioning.py'
    )
    db_ins(
        models.JOIN_JOBS_COMPONENTS, job_id=job_id,
    ...
    job_id = db_ins(
        ...
        updated_at=time[1][3], user_agent='db_provisioning.py'
    )
    db_ins(
        models.JOIN_JOBS_COMPONENTS, job_id=job_id,
        component_id=component_hp_1
    ...
    job_id = db_ins(
        ...
        updated_at=time[0][0], user_agent='db_provisioning.py'
    )
    db_ins(
        models.JOIN_JOBS_COMPONENTS, job_id=job_id,
    ...
    job_id = db_ins(
        ...
        updated_at=time[2][20], user_agent='db_provisioning.py'
    )
    db_ins(
        models.JOIN_JOBS_COMPONENTS, job_id=job_id,
        component_id=component_hp_2
    ...
    job_id = db_ins(
        ...
        updated_at=time[0][6], user_agent='db_provisioning.py'
    )
    db_ins(
        models.JOIN_JOBS_COMPONENTS, job_id=job_id,
        component_id=component_hp_2
    ...
    job_id = db_ins(
        ...
        updated_at=time[1][6], user_agent='db_provisioning.py'
    )
    db_ins(
        models.JOIN_JOBS_COMPONENTS, job_id=job_id,
        component_id=component_hp_2
    ...
    job_id = db_ins(
        ...
        updated_at=time[1][2], user_agent='db_provisioning.py'
    )
    db_ins(
        models.JOIN_JOBS_COMPONENTS, job_id=job_id,
        component_id=component_dell_2
