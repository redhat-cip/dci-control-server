...
def test_hmac_mechanism_get_client_info():
    ...
    client_info = mechanism.get_client_info({
        'DCI-Client-Info': 'remoteci/426fc04f04bf8fdb5831dc37bbb6dcf70f63a37e05a68c6ea5f63e85ae579376'
    })
    expected_client_info = {
        'type': 'remoteci',
        'id': '426fc04f04bf8fdb5831dc37bbb6dcf70f63a37e05a68c6ea5f63e85ae579376',
    }
...
def test_hmac_mechanism_invalid_header_raise_exception():
    ...
    with pytest.raises(dci_exc.DCIException):
        mechanism.get_client_info({
            'DCI-Invalid-Header': 'remoteci/426fc04f04bf8fdb5831dc37bbb6dcf70f63a37e05a68c6ea5f63e85ae579376'
        })
