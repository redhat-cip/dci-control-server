...
def test_compare_performance(user, remoteci_context, team_user_id, topic, topic_user_id):  # noqa
    ...
    testscases = res.data['performance'][0]['testcases']
    assert testscases['Testsuite_1/test_1']['delta'] == 20.
    assert testscases['Testsuite_1/test_2']['delta'] == -25.
    assert testscases['Testsuite_1/test_3[id-2fc6822e-b5a8-42ed-967b-11d86e881ce3,smoke]']['delta'] == 25.  # noqa
