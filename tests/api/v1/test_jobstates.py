...
def test_create_jobstates(admin, job_user_id):
    ...
    job = admin.get('/api/v1/jobs/%s' % job_user_id).data

    assert js['jobstate']['comment'] == 'kikoolol'
    assert job['job']['status'] == 'running'


def test_create_jobstates_empty_comment(admin, job_user_id):
...
def test_get_all_jobstates(admin, job_user_id):
...
def test_get_all_jobstates_with_pagination(admin, job_user_id):
...
def test_get_all_jobstates_with_embed(admin, job_user_id, team_admin_id):
...
def test_get_all_jobstates_with_where(admin, job_user_id, team_id):
...
def test_get_all_jobstates_with_sort(admin, job_user_id):
...
def test_get_all_jobstates_with_sub_sort(admin, job_user_id):
    # create 4 jobstates ordered by created time
    jd_1_1 = admin.post('/api/v1/jobstates',
                        data={'job_id': job_user_id,
                              'status': 'running',
...
def test_get_jobstate_by_id(admin, job_user_id):
    js = admin.post('/api/v1/jobstates',
                    data={'job_id': job_user_id,
                          'comment': 'kikoolol',
                          'status': 'running'}).data
...
def test_get_jobstate_with_embed(admin, job_user_id, team_admin_id):
...
def test_get_jobstate_with_embed_not_valid(admin, job_user_id):
    js = admin.post('/api/v1/jobstates',
                    data={'job_id': job_user_id,
                          'comment': 'kikoolol',
                          'status': 'running'}).data
...
def test_delete_jobstate_by_id(admin, job_user_id):
    js = admin.post('/api/v1/jobstates',
                    data={'job_id': job_user_id,
                          'comment': 'kikoolol',
                          'status': 'running'})
...
@pytest.mark.usefixtures('jobstate_user_id', 'jobstate_user_id')
