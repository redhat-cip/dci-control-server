...
def test_get_all_tests_with_pagination(admin, user):
    ...
    admin.post('/api/v1/tests', data={'name': 'pname1'}).data
    admin.post('/api/v1/tests', data={'name': 'pname2'}).data
    admin.post('/api/v1/tests', data={'name': 'pname3'}).data
    admin.post('/api/v1/tests', data={'name': 'pname4'}).data
