...
def test_schedule_jobs_with_new_topic(admin, user, remoteci_user_id, team_user_id):
...
def test_schedule_jobs_topic_not_active(admin, jobdefinition_id, remoteci_id,
                                  topic_id):
    """No active topic
...
def test_schedule_jobs_round_robin_rconfiguration(admin, remoteci_id, topic_id,
    ...
    print('id_1 %s' % rconfiguration_id_1)
    print('id_2 %s' % rconfiguration_id_2)
    print('id_3 %s' % rconfiguration_3.data['rconfiguration']['id'])
