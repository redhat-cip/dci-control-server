...
def test_metrics_admin(admin, remoteci_id, team_id):
    ...
    assert res.data['topics']['foo'][0]['component'] == '2017-05-27.1'
    assert res.data['topics']['foo'][0]['values'] == ['None', 'None']
    assert res.data['topics']['foo'][1]['component'] == '2017-06-01.3'
    assert res.data['topics']['foo'][1]['values'][0] != 'None'
    assert res.data['topics']['foo'][1]['values'][1] != 'None'
