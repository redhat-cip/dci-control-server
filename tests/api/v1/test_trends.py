...
def test_trends():
    jobs = [
        {
            "created_at": datetime.datetime.strptime("2018-06-27T10:29:04", "%Y-%m-%dT%H:%M:%S"),
            "status": "failure",
            "topic_id": uuid.UUID('23da2f7b-90cd-4d71-a48a-e9c88f75b5eb')
        },
        {
            "created_at": datetime.datetime.strptime("2018-06-27T14:30:02", "%Y-%m-%dT%H:%M:%S"),
            "status": "success",
            "topic_id": uuid.UUID('23da2f7b-90cd-4d71-a48a-e9c88f75b5eb')
        },
        {
            "created_at": datetime.datetime.strptime("2018-06-28T02:14:03", "%Y-%m-%dT%H:%M:%S"),
            "status": "success",
            "topic_id": uuid.UUID('23da2f7b-90cd-4d71-a48a-e9c88f75b5eb')
        },
        {
            "created_at": datetime.datetime.strptime("2018-06-28T12:08:02", "%Y-%m-%dT%H:%M:%S"),
            "status": "success",
