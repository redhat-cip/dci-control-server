...
def test_user_cert_verified_if_user_team_in_RHEL(
    admin, remoteci_context, remoteci, RHELProduct, RHEL80Topic, RHEL80Component
):
...
def test_user_cert_verified_if_user_team_in_RHEL_export_control_false(
    admin, remoteci_context, remoteci, RHELProduct, RHEL81Topic, RHEL81Component
):
    certificate_headers = get_certificate_headers(
