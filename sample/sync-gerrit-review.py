...
def main():
    ...
    for project in projects:
        ...
        for component in project['jobdefinition']['components']:
            ...
            # NOTE(Gonéri): we need to keep the data key in sync with the rest
            # of the component keys. This because the agent only see this part of
            # the configuration. See: aggregate_job_data()
