...
BuildRequires:  python-dciauth >= 1.0.1, python-dciauth < 2.0.0
...
Requires:       python-zmq
Requires:       python-jwt
Requires:       python-dciauth >= 1.0.1, python-dciauth < 2.0.0
...
BuildRequires:  python-jwt
BuildRequires:  python3-dciauth >= 1.0.1, python3-dciauth < 2.0.0
BuildRequires:  systemd
BuildRequires:  systemd-units
...
Requires:       python-jwt
Requires:       python3-dciauth >= 1.0.1, python3-dciauth < 2.0.0
