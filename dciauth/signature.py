...
def _create_string_to_sign(method, content_type, timestamp, url, query_string,
                           hashed_payload):
    elements = (method, content_type, timestamp, url, query_string,
                hashed_payload,)
    return '\n'.join(elements)
...
def generate_headers_with_secret(secret, method, content_type, url, params,
                                 payload):
    hashed_payload = _hash_payload(payload)
