...
echo "INSERT INTO users (name, password) VALUES ('admin', crypt('admin', gen_salt('bf', 8)));" >> dci-control-server.sql
echo "INSERT INTO users (name, password) values ('partner', crypt('partner', gen_salt('bf', 8)));" >> dci-control-server.sql
