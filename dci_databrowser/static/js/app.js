...
app.config(function($routeProvider, $locationProvider, $parseProvider, $httpProvider) {
    $routeProvider
    .when('/login', {
...
app.controller('LogoutController', ['$scope', '$location', '$templateCache', 'currentAuthBA',
