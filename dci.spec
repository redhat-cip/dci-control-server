...
find %{buildroot}/%{python2_sitelib}/dci* -name 'requires.txt' | xargs sed -i '2s/elasticsearch.*/elasticsearch/'
find %{buildroot}/%{python2_sitelib}/dci* -name 'requires.txt' | xargs sed -i '11s/setuptools.*/setuptools/'
find %{buildroot}/%{python2_sitelib}/dci* -name 'requires.txt' | xargs sed -i '12s/Werkzeug.*/Werkzeug/'
