...
class DciControlServer(flask.Flask):
    def __init__(self, conf, team_admin_id, team_internal_id, team_epm_id):
        ...
        self.team_internal_id = team_internal_id
...
def create_app(conf):
    team_admin_id, team_internal_id, team_epm_id = dci_config.sanity_check(conf)  # noqa
    dci_app = DciControlServer(conf, team_admin_id, team_internal_id, team_epm_id)  # noqa
    ...
    def before_request():
        ...
        flask.g.team_internal_id = dci_app.team_internal_id
