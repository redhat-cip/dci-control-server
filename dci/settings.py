...
STORE_USERNAME = os.environ.get('STORE_USERNAME ', 'test')
...
STORE_CONTAINER = os.environ.get('STORE_CONTAINER ', 'test_components')
STORE_FILES_CONTAINER = os.environ.get('STORE_FILES_CONTAINER ', 'test_files')
STORE_COMPONENTS_CONTAINER = os.environ.get('STORE_COMPONENTS_CONTAINER ', 'test_components')  # noqa
