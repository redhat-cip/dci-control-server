...
ROLES = {
    ...
    'add_tag_for_component': SUPER_ADMIN_PO_FEEDER,
    'delete_tag_for_component': SUPER_ADMIN_PO_FEEDER,
    'retrieve_tags_from_component': SUPER_ADMIN_PO_FEEDER,
    # certs
    ...
    'put_api_secret': ALL,
    'create_configuration': ALL,
    'get_all_configurations': ALL,
    'get_configuration_by_id': ALL,
    'delete_configuration_by_id': ALL,
    ...
    'get_all_issues': ALL,
    'get_issue': ALL,
    'delete_issue_by_id': SUPER_ADMIN_PO,
    'get_to_purge_archived_issues': SUPER_ADMIN,
    'purge_archived_issues': SUPER_ADMIN
}
