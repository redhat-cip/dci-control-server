...
def upgrade():
    ...
    op.drop_constraint('jobdefinition_tests_jobdefinition_id_fkey', 'jobdefinition_tests')
    op.drop_constraint('jobdefinition_tests_test_id_fkey', 'jobdefinition_tests')
    ...
    op.execute("ALTER TABLE jobdefinition_tests ALTER COLUMN jobdefinition_id TYPE \
