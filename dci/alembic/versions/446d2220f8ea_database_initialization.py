...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('updated_at', sa.DateTime(),
                  ...
                  default=datetime.datetime.utcnow, nullable=False),
        sa.Column('etag', sa.String(40), nullable=False, default=utils.gen_etag,  # noqa
        ...
        sa.Column('parent_id', pg.UUID(as_uuid=True),
                  ...
                  nullable=True),
        sa.UniqueConstraint('name', 'parent_id', name='teams_name_parent_id_key')  # noqa
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint('name', 'team_id', name='remotecis_name_team_id_key'),  # noqa
