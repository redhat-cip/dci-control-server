...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.create_table('users_teams_roles',
    ...
    sa.ForeignKeyConstraint(['team_id'], [u'teams.id'], name=u'users_teams_roles_team_id_fkey', ondelete=u'CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], [u'users.id'], name=u'users_teams_roles_user_id_fkey', ondelete=u'CASCADE')
    )
    ### end Alembic commands ###
