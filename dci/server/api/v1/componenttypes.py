...
@auth2.requires_auth
def get_componenttype_by_id_or_name(ct_id, user_info):
...
@auth2.requires_auth
def get_components_by_componenttype(ct_id, user_info):
    componenttype = _verify_existence_and_get_ct(ct_id)
...
@auth2.requires_auth
def put_componenttype(ct_id, user_info):
    # get If-Match header
...
@auth2.requires_auth
def delete_componenttype_by_id_or_name(ct_id, user_info):
    # get If-Match header
    if_match_etag = utils.check_and_get_etag(flask.request.headers)
