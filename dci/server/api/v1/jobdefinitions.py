...
@auth2.requires_auth
def get_jobdefinition_by_id_or_name(jd_id, user_info):
    # get the diverse parameters
...
@auth2.requires_auth
def delete_jobdefinition_by_id_or_name(jd_id, user_info):
    # get If-Match header
...
@auth2.requires_auth
def add_component_to_jobdefinitions(jd_id, user_info):
...
@auth2.requires_auth
def get_all_components_from_jobdefinitions(jd_id, user_info):
    _verify_existence_and_get_jd(jd_id)
...
@auth2.requires_auth
def delete_component_from_jobdefinition(jd_id, c_id, user_info):
    _verify_existence_and_get_jd(jd_id)
