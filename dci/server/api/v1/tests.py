...
@auth2.requires_auth
def get_test_by_id_or_name(t_id, user_info):
...
@auth2.requires_auth
def get_jobdefinitions_by_test(test_id, user_info):
...
@auth2.requires_auth
def delete_test_by_id_or_name(t_id, user_info):
    # get If-Match header
    if_match_etag = utils.check_and_get_etag(flask.request.headers)
