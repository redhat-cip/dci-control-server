...
class TestTest(utils.SchemaTesting):
    ...
    def test_put(self):
        expected_data = utils.dict_merge(self.data, {'data': {}})
        super(TestTest, self).test_put(self.data, expected_data)
...
class TestComponent(utils.SchemaTesting):
    ...
    def test_post_new_componenttype(self):
        ...
        data = utils.dict_merge(self.data, component_type, {'data': {}})
