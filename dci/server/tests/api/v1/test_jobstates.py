...
def test_get_all_jobstates_with_pagination(admin, job_id, team_id):
    ...
    data = {'job_id': job_id, 'team_id': team_id, 'comment': 'kikoolol1'}
    admin.post('/api/v1/jobstates', data=data)
    data = {'job_id': job_id, 'team_id': team_id, 'comment': 'kikoolol2'}
    admin.post('/api/v1/jobstates', data=data)
    data = {'job_id': job_id, 'team_id': team_id, 'comment': 'kikoolol3'}
    admin.post('/api/v1/jobstates', data=data)
    data = {'job_id': job_id, 'team_id': team_id, 'comment': 'kikoolol4'}
    admin.post('/api/v1/jobstates', data=data)
