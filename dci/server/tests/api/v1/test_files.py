...
def test_get_all_files_with_pagination(admin, jobstate_id, team_id):
    ...
    data = {'jobstate_id': jobstate_id, 'team_id': team_id, 'name': 'lol1'}
    admin.post('/api/v1/files', data=data)
    data = {'jobstate_id': jobstate_id, 'team_id': team_id, 'name': 'lol2'}
    admin.post('/api/v1/files', data=data)
    data = {'jobstate_id': jobstate_id, 'team_id': team_id, 'name': 'lol3'}
    admin.post('/api/v1/files', data=data)
    data = {'jobstate_id': jobstate_id, 'team_id': team_id, 'name': 'lol4'}
    admin.post('/api/v1/files', data=data)
...
def test_get_file_by_id(admin, jobstate_id, team_id):
    file = admin.post('/api/v1/files',
                      data={'jobstate_id': jobstate_id, 'team_id': team_id,
                            'name': 'kikoolol'}).data
    file_id = file['file']['id']
