...
JOIN_REMOTECIS_RFLAVORS = sa.Table(
    'remotecis_rflavors', metadata,
    sa.Column('remoteci_id', pg.UUID(as_uuid=True),
              sa.ForeignKey('remotecis.id', ondelete='CASCADE'),
              nullable=False, primary_key=True),
    sa.Column('rflavor_id', pg.UUID(as_uuid=True),
              sa.ForeignKey('rflavors.id', ondelete='CASCADE'),
              nullable=False, primary_key=True))

REMOTECIS_FLAVORS = sa.Table(
    'rflavors', metadata,
    sa.Column('id', pg.UUID(as_uuid=True), primary_key=True,
              default=utils.gen_uuid),
    sa.Column('created_at', sa.DateTime(),
