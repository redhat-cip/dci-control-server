...
COMPONENTS = sa.Table(
    ...
    sa.Column(
        "released_at", sa.DateTime(), default=datetime.datetime.utcnow, nullable=False
    ),
    sa.Column(
        "etag",
        sa.String(40),
    ...
    sa.UniqueConstraint(
        "name", "topic_id", "type", "team_id", name="name_topic_id_type_team_id_unique"
    ),
...
JOBS = sa.Table(
    ...
    # nullable=False after the data migration
    sa.Column(
        "product_id",
        pg.UUID(as_uuid=True),
