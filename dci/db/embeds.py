        ...
        "files": [
            {
                "right": models.FILES,
                "onclause": and_(
                    models.FILES.c.job_id == root_select.c.id,
        ...
        "issues": [
            {
                ...
                "onclause": models.JOIN_JOBS_ISSUES.c.job_id == root_select.c.id,
                "isouter": True,
            },
            {
                "right": models.ISSUES,
...
def components(root_select=models.COMPONENTS):
    return {
        ...
        "jobs": [
            {
                "right": models.JOIN_JOBS_COMPONENTS,
                "onclause": models.JOIN_JOBS_COMPONENTS.c.component_id
                == root_select.c.id,
                "isouter": True,
            },
            {
        ...
        "files": [
            {
                "right": models.FILES,
                "onclause": and_(
                    models.FILES.c.jobstate_id == root_select.c.id,
                    models.FILES.c.state != "archived",
                ),
                "isouter": True,
            }
        ...
        "topics": [
            {
                ...
                "onclause": models.JOINS_TOPICS_TEAMS.c.team_id == root_select.c.id,
                "isouter": True,
            },
            {
                "right": models.TOPICS,
        ...
        "remotecis": [
            {
                ...
                "onclause": and_(
                    models.REMOTECIS.c.team_id == root_select.c.id,
        ...
        "topics": [
            {
                "right": models.TOPICS,
                "onclause": and_(
                    models.TOPICS.c.product_id == root_select.c.id,
                    models.TOPICS.c.state != "archived",
                ),
                "isouter": True,
            }
...
def topics(root_select=models.TOPICS):
    return {
        "teams": [
            {
                "right": models.JOINS_TOPICS_TEAMS,
                "onclause": models.JOINS_TOPICS_TEAMS.c.topic_id == root_select.c.id,
                "isouter": True,
            },
            {
                "right": models.TEAMS,
    ...
    return {
        "team": [
            ...
            },
            {
                "right": TEAM,
                "onclause": and_(
                    TEAM.c.id == JOIN_USERS_TEAMS.c.team_id, TEAM.c.state != "archived"
                ),
                "isouter": True,
            },
        ],
        "remotecis": [
            {
                ...
                "onclause": models.JOIN_USER_REMOTECIS.c.user_id == root_select.c.id,
                "isouter": True,
            },
            {
                "right": models.REMOTECIS,
                "onclause": and_(
                    models.REMOTECIS.c.id == models.JOIN_USER_REMOTECIS.c.remoteci_id,
                    models.REMOTECIS.c.state != "archived",
                ),
                "isouter": True,
            },
...
EMBED_STRING_TO_OBJECT = {
    ...
    "remotecis": {"team": TEAM},
    "components": {"files": CFILES, "jobs": models.JOBS},
    "feeders": {"team": TEAM},
    "files": {
        "jobstate": JOBSTATE,
    ...
    "teams": {"remotecis": models.REMOTECIS, "topics": models.TOPICS},
    "topics": {"teams": models.TEAMS, "product": PRODUCT, "next_topic": NEXT_TOPIC},
    "users": {"team": TEAM, "remotecis": models.REMOTECIS},
}
