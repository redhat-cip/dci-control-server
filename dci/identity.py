...
class Identity:
    ...
    def is_super_admin_or_product_owner(self):
        """Ensure the user has the role of SUPER_ADMIN or PRODUCT_OWNER."""

        return self.is_super_admin() or self.is_product_owner()
