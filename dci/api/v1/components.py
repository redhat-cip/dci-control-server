...
@api.route('/components/tags/purge', methods=['GET'])
@decorators.login_required
@decorators.check_roles
def get_to_purge_archived_components(user):
    return base.get_to_purge_archived_resources(user, _TABLE_TAGS)


@api.route('/components/tags/purge', methods=['POST'])
@decorators.login_required
@decorators.check_roles
def purge_archived_components(user):
    return base.purge_archived_resources(user, _TABLE_TAGS)
