...
def _build_new_template2(topic_id, remoteci, values, previous_job_id=None):
    ...
    # jobdefinition will be removed, used here for not breaking jobs table.
    # Get a jobdefinition
    q_jd = sql.select([models.JOBDEFINITIONS]).where(
...
def schedule_jobs2(user):
    ...
    values = _build_new_template2(topic_id, remoteci, values)
