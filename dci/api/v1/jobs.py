...
def _build_new_template(topic_id, remoteci, components_ids, values,
    ...
    component_types = scheduler.get_component_types(topic_id, remoteci['id']
    schedule_components_ids = scheduler.verify_and_get_components_ids(
...
def schedule_jobs(user):
    ...
    scheduler.killer_existing_jobs(remoteci['id'], topic['id'])
