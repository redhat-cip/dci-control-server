...
def purge_archived_files(user):
    ...
    q_archived_files = v1_utils.QueryBuilder(_TABLE)
    q_archived_files.add_extra_condition(_TABLE.c.state == 'archived')
    archived_files = q_archived_files.execute(fetchall=True, use_labels=False)
